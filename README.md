...
The purpose of this repository is to reconstruct seismic attribute and visualize the result with 3D model visualization. We construct this using **Python** and **Jupyter Notebook IDE**.
